...
export const getLastestFlashcardsCreated = async (req: Request, res: Response): Promise<void> => {
    try {
        const { userId } = req.params
        const data = await dashboardService.getLastestFlashcardsCreated(userId)
